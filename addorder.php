  ...
  //do stuff
								...
								<form action="" method="post" name="search" id="search">
									<div class="section_inner_ lrg">
										<div class="six">
											<input type="text" name="quality" value="" placeholder="Quality">
										</div>
										<div class="six">
								...
								?>
									<form action="" method="post" name='order' id="order" enctype="multipart/form-data">
										...
										<div class="input-group">
											...
											<div class="input-group">
												<input type="text" name="datepicker" id="datepicker" placeholder="Delivery date">
												<div class="input-group-addon">
                                                <i class="fa fa-asterisk"></i>
                                            </div>
											</div>
											...
											<div class="six">
												<input type="submit" name="order" value="Create Order" class="button bb">
											</div>
											<div class="clear"></div>

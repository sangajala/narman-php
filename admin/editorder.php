...
if(isset($_POST['order']))
{
	...
	$update=mysql_query("Update `order` SET `quality`='$quality', `agent`='$agent', `supplier`='$supplier', `weight`='$weight', `width`='$width', `fabric_type`='$component', `construction`='$construction', `qualitycolor`='$qualitycolor', `color`='$color', `colordetail`='$colordetail', `price`='$price', `currency`='$currency', `quantity`='$quantity', `orderweight`='$orderweight', `datepicker`='$datepicker', `term`='$term', `mode`='$mode', `address1`='$address1', `address2`='$address2', `customerref`='$customerref', `customer`='$customer', `customerdate`='$customerdate', `testing`='$testing', `tparameter`='$tparameter', `agentclarity`='$agentclarity', `comment`='$comment', `commission`='$commission', `care`='$care', `group`='$group', `trmcondition`='$trmcondition' WHERE `id`='$id'") or die($update . mysql_error());
	$success= "<div class='green'>Order updated successfully</div>";
}
$query = mysql_query("select * from `order` where `id`='$id'") or die(mysql_error());
} 
?>
								...
								?>
									<form action="" method="post" name='order' id="order" enctype="multipart/form-data">
										...
										<div class="input-group">
											<div class="drop_b">
											<input type="hidden" id="se_quality" name="se_quality" value="<?php echo $details['quality']; ?>">
												...
												if(mysql_num_rows($sql) > 0)
												{
													...
													{ ?>
														<option value="<?php echo $rw['name']; ?>" <?php if($details['agent'] == $ag ) echo 'selected="selected,"'; ?>><?php echo $rw['name']; ?> </option>
														<?php
													}
												}
												else
												...
												<div class="drop_b">
													...
													if(mysql_num_rows($sql1) > 0)
													{
														...
														while($rw1=mysql_fetch_array($sql1))
														{
															...
															<option value="<?php echo $rw1['name'];?>" <?php if($details['supplier'] == $ss) echo 'selected="selected"'; ?>><?php echo $rw1['name']; ?></option>
															<?php
														}
													}
													else
											...
											<div class="input-group">
												<input type="text" name="weight" id="weight" value="<?php echo $details['weight']; ?>" placeholder="Weight in kgs">
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk"></i>
                                            </div>
											</div>
											...
											<div class="input-group">
												<input type="text" name="width" id="width" value="<?php echo $details['width']; ?>" placeholder="Width in mts">
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk"></i>
                                            </div>
											</div>
													...
													<select name="component" id="component">
														...
														<?php
															...
															while($result1 = mysql_fetch_array($query1))
															{
																$fab = $result1['name'];
																?>
															<option value="<?php echo $result1['name']; ?>" <?php if($details['fabric_type'] == $fab) echo 'selected="selected"'; ?>><?php echo $result1['name']; ?></option>
															<?php
															}
															}
															else
											...
											<div class="input-group">
												<textarea rows="4" cols="50" name="construction" id="construction" placeholder="Construction details"><?php echo $details['construction']; ?></textarea>
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk ffff"></i>
                                            </div>
											</div>
											...
											<div class="input-group">
												<input type="text" name="qualitycolor" id="qualitycolor" value="<?php echo $details['qualitycolor']; ?>" placeholder="Quality Color">
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk ffff"></i>
                                            </div>
											</div>
											...
											<div class="input-group">
												<div class="drop_b">
													<?php
													 $comp	= explode(",", $details['color']);
													?>												
													 <input type="text" name="color[]" id="color1" class="colour" value="<?php echo $comp[0];?>" placeholder="Add his own color">
											...
											<div class="input-group">
												<input type="text" name="colordetail" id="colordetail" value="<?php echo $details['colordetail']; ?>" placeholder="Color Details">
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk ffff"></i>
                                            </div>
											</div>
											...
											<div class="input-group">
												<input type="text" name="price" id="price" value="<?php echo $details['price']; ?>" placeholder="Price">
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk"></i>
                                            </div>
											</div>
											...
											<div class="input-group">
												<div class="drop_b">   
													 <select name="currency" id="currency">
														 ...
														 <option value="INR" <?php if($details['currency'] == "INR") echo 'selected="selected"'; ?>>INR</option>
														 <option value="DOLLER" <?php if($details['currency'] == "DOLLER") echo 'selected="selected"'; ?>>DOLLAR</option>
													 </select>
												</div>
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk"></i>
											...
											<div class="input-group">
												<input type="text" name="quantity" id="quantity" value="<?php echo $details['quantity']; ?>" placeholder="Quantity in mts">
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk"></i>
                                            </div>
											</div>
											...
											<div class="input-group">
												<input type="text" name="orderweight" id="orderweight" value="<?php echo $details['orderweight']; ?>" placeholder="Order Weight in Kgs">
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk"></i>
                                            </div>
											</div>
											...
											<div class="input-group">
												<input type="text" name="datepicker" id="datepicker" placeholder="Delivery date" value="<?php echo $details['datepicker']; ?>">
												<div class="input-group-addon">
                                                <i class="fa fa-asterisk"></i>
                                            </div>
											</div>
											...
											<div class="input-group">
												<div class="drop_b">   
													 <select name="term" id="term">
														 ...
														 <option value="FOB" <?php if($details['term'] == "FOB") echo 'selected="selected"'; ?>>FOB</option>
														 <option value="FOB" <?php if($details['term'] == "FOB") echo 'selected="selected"'; ?>>FOB</option>
													 </select>
												</div>
											<div class="input-group-addon">
											...
											<div class="input-group">
												<div class="drop_b">   
													 <select name="mode" id="mode">
														 ...
														 <option value="Sea" <?php if($details['mode'] == "Sea") echo 'selected="selected"'; ?>>Sea</option>
														 <option value="Sea" <?php if($details['mode'] == "Sea") echo 'selected="selected"'; ?>>Sea</option>
													 </select>
												</div>
											<div class="input-group-addon">
											...
											<div class="input-group">
												<div class="drop_b">   
													 <select name="address1" id="address1">
														 ...
														 <option value="151 Lathom Road" <?php if($details['address1'] == "151 Lathom Road") echo 'selected="selected"'; ?>>151 Lathom Road</option>
														 <option value="151 Lathom Road" <?php if($details['address1'] == "151 Lathom Road") echo 'selected="selected"'; ?>>151 Lathom Road</option>
													 </select>
												</div>
											<div class="input-group-addon">
											...
											<div class="input-group">
												<div class="drop_b">   
													 <select name="address2" id="address2">
														 <option value="">Please select a Delivery address</option>
														 <option value="Immediate 70 advance" <?php if($details['address2'] == "Immediate 70 advance") echo 'selected="selected"'; ?>>Immediate 70 advance</option>
														 <option value="Immediate 70 advance" <?php if($details['address2'] == "Immediate 70 advance") echo 'selected="selected"'; ?>>Immediate 70 advance</option>
													 </select>
												</div>
											<div class="input-group-addon">
											...
											<div class="input-group">
												<input type="text" name="customerref" id="customerref" placeholder="Customer Reference" value="<?php echo $details['customerref']; ?>">
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk ffff"></i>
                                            </div>
											</div>
											...
											<div class="input-group">
												<input type="text" name="customer" id="customer" placeholder="Customer" value="<?php echo $details['customer']; ?>">
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk ffff"></i>
                                            </div>
											</div>
											...
											<div class="input-group">
												<input type="text" name="customerdate" id="customerdate" placeholder="Customer Reference date" value="<?php echo $details['customerdate']; ?>">
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk ffff"></i>
                                            </div>
											</div>
											...
											<div class="input-group">
												<div class="drop_b">   
													 <select name="testing" id="testing">
														 ...
														 <option value="Yes" <?php if($details['testing'] == "Yes") echo 'selected="selected"'; ?>>Yes</option>
														 <option value="No" <?php if($details['testing'] == "No") echo 'selected="selected"'; ?>>No</option>
													 </select>
												</div>
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk ffff"></i>
											...
											<div class="input-group">
												<div class="drop_b">   
													 <select name="tparameter[]" id="tparameter" multiple="multiple">
														 ...
														 <option value="Test1" <?php if($details['tparameter'] == "Test1") echo 'selected="selected"'; ?>>Test1</option>
														 <option value="Test2" <?php if($details['tparameter'] == "Test2") echo 'selected="selected"'; ?>>Test2</option>
													 </select>
												</div>
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk ffff"></i>
											...
											<div id="mypic">
											<?php
											$pic	= explode(",", $details['symbol']);
											foreach($pic as $value)
											{
												?>
												<div id="filediv">
												<div class="abcd"><img src="upload/<?php echo $value;?>" alt="<?php echo $value;?>"></div>
												</div>
												<?php
											}
											?>
											...
											<div class="input-group">
												<div class="drop_b">   
												<?php
												$care1	= explode(",", $details['care']);
												?>
													 <select name="care" id="care" multiple="multiple">
														 <option value="Carewording" <?php if(in_array("Carewording", $care1)) echo "selected"; ?>>Carewording</option>
														 <option value="Carewording1" <?php if(in_array("Carewording1", $care1)) echo "selected"; ?>>Carewording1</option>
														 <option value="Carewording2" <?php if(in_array("Carewording2", $care1)) echo "selected"; ?>>Carewording2</option>
													 </select>
												</div>
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk ffff"></i>
											...
											<div class="input-group">
												<div class="drop_b">   
													 <select name="agentclarity" id="agentclarity">
														 ...
														 <option value="Yes" <?php if($details['agentclarity'] == "Yes") echo 'selected="selected"'; ?>>Yes</option>
														 <option value="No" <?php if($details['agentclarity'] == "No") echo 'selected="selected"'; ?>>No</option>
													 </select>
												</div>
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk ffff"></i>
											...
											<div class="input-group">
												<textarea rows="4" cols="50" name="comment" id="comment" placeholder="Order Comment"><?php echo $details['comment']; ?></textarea>
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk ffff"></i>
                                            </div>
											</div>
											...
											<div class="input-group">
												<input type="text" name="commission" id="commission" value="<?php echo $details['commission']; ?>" placeholder="Agent commission">
											<div class="input-group-addon">
                                                <i class="fa fa-asterisk ffff"></i>
                                            </div>
											</div>
											...
											<div class="six">
												...
												<div class="drop_b">   
													 <select name="group" id="group">
														 ...
														 <option value="Group1" <?php if($details['group'] == "Group1") echo 'selected="selected"'; ?>>Group1</option>
														 <option value="Group2" <?php if($details['group'] == "Group2") echo 'selected="selected"'; ?>>Group2</option>
													 </select>
												</div>
											...
											<div class="six">
												...
												<div class="drop_b">   
													 <select name="trmcondition" id="trmcondition">
														 ...
														 <option value="I agree"<?php if($details['trmcondition'] == "I agree") echo 'selected="selected"'; ?>>I agree</option>
													 </select>
												</div>
											...
											<div class="six">
												<input type="submit" id="submitting" name="order" value="Update Order" class="button bb">
											</div>
											<div class="clear"></div>
